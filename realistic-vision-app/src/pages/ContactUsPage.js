				...
				<div className="col-12 col-lg-4 col-sm-12 col-md-5 mt-5">
					<Container>
						...
						<div className="col-12 mt-3 text-center">
							<h1 className="text-center">
								{workingScheduleSection?.title}
							</h1>
							<hr className="w-25 m-auto mb-3" />
							<ul style={{ listStyleType: 'none' }}>
								{workingScheduleSection?.hoursList?.map(
									(listItem, index) => {
						...
						>
							...
							>
								<Form.Control
									type="text"
									placeholder={
										formSection?.nameField?.placeholder
									}
							...
							>
								<Form.Control
									type="email"
									placeholder={
										formSection?.emailField?.placeholder
									}
									required
									className="bg-dark text-light"
									name="email"
							...
							>
								<Form.Control
									type="text"
									placeholder={
										formSection?.subjectField?.placeholder
									}
									required
									className="bg-dark text-light"
									name="subject"
							...
							>
								<Form.Control
									...
									required
									placeholder={
										formSection?.bodyField?.placeholder
									}
									rows={50}
									className="bg-dark text-light"
									style={{
